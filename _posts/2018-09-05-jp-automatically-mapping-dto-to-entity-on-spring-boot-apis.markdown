...
[「DTO は Java アプリケーション上のデータ整合性を保つのに役立ちます。」](https://twitter.com/intent/tweet?text=%22DTOs+can+help+us+to+keep+the+integrity+of+data+on+Java+applications.%22%20via%20@auth0%20http://auth0.com/blog/automatically-mapping-dto-to-entity-on-spring-boot-apis/)

[これをツイートする ](https://twitter.com/intent/tweet?text=%22DTOs+can+help+us+to+keep+the+integrity+of+data+on+Java+applications.%22%20via%20@auth0%20http://auth0.com/blog/automatically-mapping-dto-to-entity-on-spring-boot-apis/)
